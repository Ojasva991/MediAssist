...
from app.routes import admin_analytics, admin_users, analyze, auth, caregivers, documents, drug_interactions, emergency, history, passport, rag_review, reminders
